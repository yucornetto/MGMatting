...
## Check out visual results and comparisons of MG Matting to other fully automatic matting systems and matting models at [Google Drive - System Comparison](https://drive.google.com/file/d/1fTEWWDcxxENAcux8wiESDmtG3AxsZevP/view?usp=sharing), [Google Drive - Model Comparison](https://drive.google.com/file/d/1kvkMQArxK_4HcxVxp7NPlNUdNE6I9sLa/view?usp=sharing) or preview them at [SYSTEM.md](result/SYSTEM.md) and [IMAGE.md](result/IMAGE.md)!
