...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred-dir', type=str, default='./predRWP/MGMatting-DIM-Solid-PRN_40_20_10-RWA_latest_model.pth/', help="pred alpha dir")
    ...
    parser.add_argument('--trimap-dir', type=str, default='/export/ccvl12b/qihang/MGMatting/data/RealWorldPortrait-636/detailmap/', help="trimap dir")
    ...
    for img in os.listdir(args.label_dir):
        ...
        trimap = cv2.imread(os.path.join(args.trimap_dir, img.replace('.png', '_cloud_trimap.jpg')), 0).astype(np.float32)
